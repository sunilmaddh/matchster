        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                widget: Column(
                  ...
                  children: [
                    ...
                    ClipRRect(
                      ...
                      child:
                          _controller.allPfFames != null &&
                                  _controller.allPfFames.isNotEmpty
                              ? CommonAssets.networkImage(
                                _controller.allPfFames.first.url!,
                              )
                              : SizedBox.shrink(),
                    ),
                  ],
              ...
              15.hBox,
              if (_controller.allPfFames != null &&
                  _controller.allPfFames.isNotEmpty)
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    Column(
                      children: List.generate(
                        _controller.allPfFames.length - 1,
                        (index) {
                          return Padding(
                            padding: EdgeInsets.only(bottom: 15.h),
                            child: CommonCard(
                              widget: ClipRRect(
                                borderRadius: BorderRadius.circular(20.r),
                                child: CommonAssets.networkImage(
                                  _controller.allPfFames[index + 1].url!,
                                ),
                              ),
                            ),
                          );
