...
class ProfilePreviewScreen extends BaseView<ProfileController> {
  ...
  @override
  State<ProfilePreviewScreen> createState() => _PhotoPreviewScreenState();
}

class _PhotoPreviewScreenState
    extends BaseViewState<ProfileController, ProfilePreviewScreen> {
