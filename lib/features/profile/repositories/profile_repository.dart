...
class ProfileRepository {
  ...
  Future<BaseResponse<Map<String, dynamic>>> addZodiacsign({
    ...
    return await profileService.addZodiacsign(zodiacsign: zodiacsign);
  }
  ...
  Future<BaseResponse<void>> getEmailOtp({required String email}) async {
    return profileService.sendEmailOtp(email: email);
  }
  ...
  Future<BaseResponse<void>> verifyEmailOtp({
    ...
    return profileService.verifyEmailOtp(email: email, otp: otp);
  }
  ...
  Future<BaseResponse<void>> swapFames({
    ...
    return profileService.swapFames(position1: position1, position2: position2);
  }
}
