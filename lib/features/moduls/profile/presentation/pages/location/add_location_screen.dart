...
import 'package:matchster/features/moduls/profile/presentation/pages/location/search_location_screen.dart';
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            ...
            Obx(() {
              final lat = _controller.lattitude;
              final lng = _controller.longitude;
              return GoogleMap(
