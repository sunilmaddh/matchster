  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: Padding(
        padding: 29.horizontalPadding + 30.verticalPadding,
        child: Column(
                  ...
                  Align(
                    ...
                    child: CircleGradiantCard(
                      ...
                      widget: Padding(
                        ...
                        child: SvgPicture.asset(AppAssets.sendAssets),
                      ),
                    ),
                  ),
                ],
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            /// Description Text
            Padding(
              padding: 37.horizontalPadding,
              child: CommonText.text(
                "Start conversation with Josh right now and get to know each other!",
                textAlign: TextAlign.center,
                maxLines: 2,
              ),
            ),
