...
class FilterSmokeWidget extends StatelessWidget {
  const FilterSmokeWidget({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    return CommonCard(
      ...
      widget: FilterCommonWidget(
        title: AppStrings.filterString.smokingTitle,
        subtitle: AppStrings.filterString.smokingSub,
        list: SmokDrinkPreferenceExt.list,
        onTop: (v) {
          controller.selectedSmoke.value = v;
        },
        isSelected: (v) => controller.selectedSmoke.value == v,
      ),
    );
  }
}
